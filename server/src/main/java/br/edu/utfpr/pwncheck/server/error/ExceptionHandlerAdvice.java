...
import br.edu.utfpr.pwncheck.server.error.exception.Conflict;
...
public class ExceptionHandlerAdvice {
    ...
    public ApiError handlerTooManyRequestException(HttpClientErrorException.TooManyRequests exception,
                                                   HttpServletRequest request) {
        return new ApiError(
                HttpStatus.TOO_MANY_REQUESTS.value(),
                "Erro 429: Rate limit da API HIBP excedido",
